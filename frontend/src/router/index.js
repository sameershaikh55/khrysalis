...
const AppRouter = () => {
    return (
        <Routes>
            ...
            <Route path='/help-notification' element={<HelpNotificationPage />}></Route>
            <Route path='/channel/main' element={<ChannelMainPage />}></Route>
            <Route path='/channel/dashboard' element={<ChannelDashboardPage />}></Route>
            <Route path='/channel/content' element={<ChannelContentPage />}></Route>
            <Route path='/channel/analytics' element={<ChannelAnalyticsPage />}></Route>
            <Route path='/channel/comments/mentions' element={<ChannelCommentsMentionPage />}></Route>
            <Route path='/channel/subtitles' element={<ChannelSubtitlesPage />}></Route>
            <Route path='/channel/copyrights' element={<ChannelCopyrightPage />}></Route>
            <Route path='/channel/earn' element={<ChannelEarningPage />}></Route>
            <Route path='/channel/customization' element={<ChannelCustomizationPage />}></Route>
            <Route path='/channel/audio-library' element={<ChannelAudioLibraryPage />}></Route>
            <Route path='/subscription' element={<SubscriptionHomePage />}></Route>
            <Route path='/subscription/videos' element={<SubscriptionVideoPage />}></Route>
            <Route path='/subscription/playlist' element={<SubscriptionPlaylistPage />}></Route>
            <Route path='/subscription/community' element={<SubscriptionCommunityPage />}></Route>
            <Route path='/subscription/channels' element={<SubscriptionChannelPage />}></Route>
            <Route path='/subscription/about' element={<SubscriptionAboutPage />}></Route>
            ...
            <Route path='/settings/notifications' element={<SettingsNotificationPage />}></Route>
            <Route path='/settings/performance&playback' element={<PerformanceAndPlaybackPage />}></Route>
            <Route path='/settings/downloads' element={<DownloadsPage />}></Route>
            <Route path='/settings/privacy' element={<PrivacyPage />}></Route>
            <Route path='/settings/connected-apps' element={<ConnectedAppsPage />}></Route>
            <Route path='/settings/billing&payment' element={<BillingsAndPaymentPage />}></Route>
