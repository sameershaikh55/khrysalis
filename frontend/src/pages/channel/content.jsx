                    ...
                    <div className="flex justify-between relative top-[72px]">
                        ...
                        <div className="w-[86%]">
                            ...
                            <div className="flex justify-between items-center text-white mt-6">
                                <div>
                                    <label className="flex items-center gap-x-2"><input type="checkbox" name="" id="" className="outline-violet-700 bg-none text-black focus-visible:outline-none" /><span>Videos</span></label>
                                </div>
                            ...
                            <div className="flex items-center justify-center flex-col text-white w-full text-center mt-6">
