...
const SubscriptionPlaylistPage = () => {
    const categories = [
        'All',
        'Trending',
        'Live',
                    ...
                    <div className="flex justify-between relative top-[72px]">
                        ...
                        <div className="w-[86%]">
                            <div className="flex justify-center items-center">
                                <img src={blipsIcon} className="w-8" alt="" />
                            </div>
                            ...
                            <div className="mt-4">
                                ...
                                <div className="flex items-center">
                                    <div className="mt-10 flex gap-3 items-start flex-wrap justify-around">
                                        {
                                            tabs?.map((val, index) => <Button path={val?.path} enabled={"Playlist"}>
                                                {val?.title}
                                            </Button>)
                                        }
                                    </div>
...
export default SubscriptionPlaylistPage