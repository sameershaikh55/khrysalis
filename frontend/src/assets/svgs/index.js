...
const CalenderSvg = ({ width, height }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 11 11" fill="none">
            <path d="M3.5 0.530273V1.93008" stroke="white" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M7.49994 0.530273V1.93008" stroke="white" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M1.25 3.83789H9.75" stroke="white" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M10 3.56347V7.52958C10 8.92939 9.25 9.86259 7.5 9.86259H3.5C1.75 9.86259 1 8.92939 1 7.52958V3.56347C1 2.16367 1.75 1.23047 3.5 1.23047H7.5C9.25 1.23047 10 2.16367 10 3.56347Z" stroke="white" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M7.34729 5.98926H7.3527" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M7.34717 7.38867H7.35258" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M5.4978 5.98926H5.50321" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M5.49756 7.38867H5.50297" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M3.64697 5.98926H3.65237" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M3.64697 7.38867H3.65237" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
    )
}
...
const VerifiedTick = ({ width, height }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 26 27" fill="none">
            <circle cx="13.3557" cy="13.408" r="12.6174" fill="#5213AA" />
            <path d="M6.14551 13.408L10.6517 17.9142L20.5654 9.80298" stroke="white" />
        </svg>
    )
}
const Hamburger = ({ width, height }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 25 17" fill="none">
