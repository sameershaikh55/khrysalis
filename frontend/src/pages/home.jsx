            ...
            <div className="w-[86%]">
              ...
              <div className="flex max-h-[333px] mt-3">
                <div className="w-[55%] relative">
                  ...
                  <span className="absolute text-white-false right-2 top-2 bg-gray-600 px-2 rounded-xl text-sm">
                    00:07
                  </span>
                </div>
                <div className="w-[45%]">
                  <div className="h-1/2 relative">
                    ...
                    <div className="absolute bottom-4 left-2 text-white-false">
              ...
              <div className="mt-3">
                <h1 className="font-semibold border-b-2 text-white-false relative top-[1px] w-fit border-blue-600 z-10">
                  Live
                </h1>
                <LineDivider />
